...
export type Query = {
  __typename?: 'Query';
  DetectLoggedInUser?: Maybe<User>;
  getAllTweets?: Maybe<Array<Maybe<Tweet>>>;
  getCurrentUser?: Maybe<User>;
  getOnlyName?: Maybe<Scalars['String']['output']>;
...
export type QueryDetectLoggedInUserArgs = {
...
export type Tweet = {
  ...
  likeIds?: Maybe<Array<Maybe<Scalars['String']['output']>>>;
};
...
export type LikeTweetMutation = { __typename?: 'Mutation', likeTweet?: { __typename?: 'Tweet', id: string, content: string, likeIds?: Array<string | null> | null } | null };
...
export type GetAllTweetsQuery = { __typename?: 'Query', getAllTweets?: Array<{ __typename?: 'Tweet', id: string, content: string, imageURL?: string | null, likeIds?: Array<string | null> | null, author?: { __typename?: 'User', id: string, firstName: string, lastName: string, profileImageUrl?: string | null } | null } | null> | null };
...
export type GetCurrentUserQuery = { __typename?: 'Query', getCurrentUser?: { __typename?: 'User', id: string, profileImageUrl?: string | null, email: string, firstName: string, lastName: string, recommendedUser?: Array<{ __typename?: 'User', id: string, firstName: string, lastName: string, profileImageUrl?: string | null } | null> | null, followers?: Array<{ __typename?: 'User', id: string, firstName: string, lastName: string, profileImageUrl?: string | null } | null> | null, following?: Array<{ __typename?: 'User', id: string, firstName: string, lastName: string, profileImageUrl?: string | null } | null> | null, tweets?: Array<{ __typename?: 'Tweet', id: string, content: string, imageURL?: string | null, likeIds?: Array<string | null> | null, author?: { __typename?: 'User', id: string, firstName: string, lastName: string, profileImageUrl?: string | null, following?: Array<{ __typename?: 'User', id: string } | null> | null, followers?: Array<{ __typename?: 'User', id: string } | null> | null } | null } | null> | null } | null };
...
export type GetuserByIdQuery = { __typename?: 'Query', getUserById?: { __typename?: 'User', id: string, firstName: string, lastName: string, profileImageUrl?: string | null, recommendedUser?: Array<{ __typename?: 'User', id: string, firstName: string, lastName: string, profileImageUrl?: string | null } | null> | null, followers?: Array<{ __typename?: 'User', id: string, firstName: string, lastName: string, profileImageUrl?: string | null } | null> | null, following?: Array<{ __typename?: 'User', id: string, firstName: string, lastName: string, profileImageUrl?: string | null } | null> | null, tweets?: Array<{ __typename?: 'Tweet', id: string, content: string, imageURL?: string | null, likeIds?: Array<string | null> | null, author?: { __typename?: 'User', id: string, firstName: string, lastName: string, profileImageUrl?: string | null } | null } | null> | null } | null };
...
export const LikeTweetDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"LikeTweet"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"likeTweet"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"tweetId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"content"}},{"kind":"Field","name":{"kind":"Name","value":"likeIds"}}]}}]}}]} as unknown as DocumentNode<LikeTweetMutation, LikeTweetMutationVariables>;
